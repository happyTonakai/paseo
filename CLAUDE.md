...
| [docs/notifications.md](docs/notifications.md)                       | Remote push routing: the in-app vs remote push channels, the presence window, and `daemon.notifications.policy`                |
